...
import { Mail, Lock, ArrowRight, Sparkles, ShieldCheck, Zap, Radio, User } from 'lucide-react';
      ...
      >
        ...
        <div className="auth-right-form-col">
          <div className="auth-form-header">
            <h2 style={{ fontSize: '24px', fontWeight: 800, margin: '0 0 4px 0', color: '#ffffff' }}>
              Welcome Back
            </h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <a href="#forgot" onClick={(e) => e.preventDefault()} style={{ fontSize: '11px', color: '#ff6b35', textDecoration: 'none', fontWeight: 600 }}>
                  Forgot?
                </a>
              </div>
              <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: '2px 0' }}>
              ...
              />
              <label htmlFor="remember" style={{ fontSize: '12px', color: '#a0a5b5', cursor: 'pointer' }}>
          ...
          <div style={{
            ...
            <Link to="/registration" style={{ color: '#ff6b35', fontWeight: 700, textDecoration: 'none' }}>
              Sign Up
            </Link>
          </div>
        </div>
